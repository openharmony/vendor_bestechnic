...
var _system = _interopRequireDefault(requireModule("@system.audio"));
...
var _default = {
  ...
  onInit: function onInit() {
    ...
    _system["default"].onplay = function () {
      ...
      this.curMusic.allTime = this.timeChange(_system["default"].duration);
      this.playStatus = 0;
    }.bind(this);
    ...
    _system["default"].ontimeupdate = function () {
      ...
      if (_system["default"].duration == null || _system["default"].duration <= 0) {
        return;
      }

      console.log("ontime update:");
      this.curMusic.playTime = this.timeChange(_system["default"].currentTime);
      console.log("ontime update:" + this.curMusic.playTime);
      this.playProgress = Math.floor(_system["default"].currentTime * 100 / _system["default"].duration);
      console.log("ontime update progress:" + this.playProgress + ",duration:" + _system["default"].duration);
    }.bind(this);
  ...
  changeProgress: function changeProgress(value) {
    ...
    var val = Math.floor(value.progress / 100 * _system["default"].duration);
    console.log("changeProgress change:" + val);
    _system["default"].currentTime = val;
  ...
  stopPlay: function stopPlay() {
    ...
    _system["default"].src = null;
    _system["default"].onstop = null;
    _system["default"].onplay = null;
    _system["default"].ontimeupdate = null;
    _system["default"].onerror = null;
  },
